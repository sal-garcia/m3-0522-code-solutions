...
const balance = account.reduce((previousValue,currentValue)=>{
  if(currentValue.type==='deposit'){
    previousValue+= currentValue.amount// adds all the deposits to previousValue
  }else{
    previousValue -= currentValue.amount// subtracts all of the withdrawls to previousValue
  }
